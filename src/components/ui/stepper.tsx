            ...
            >
              <Button
                ...
                className={cn(
                  ...
                  dataState === "active" && "ring-2 ring-primary ring-offset-2 ring-offset-background"
                )}
                variant={dataState !== "inactive" ? "default" : "outline"}
                size="icon"
              ...
              <div
                ...
                className={cn(
                  "flex flex-col",
                  labelOrientation === "vertical" ? "items-center mt-2" : "items-start"
                )}
              >
                {title}
                {description}
